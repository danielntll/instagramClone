const allUsers = [
    ...
    post: [
      {
        ...
        comments: [
          ...
          },
          {
            ...
            username: "utente1",
            userimage:
              "https://robohash.org/SarahBrown.png?size=50x50&set=set1",
            comment: "Dolor",
            likes: [
              {
                userId: "userId00000002",
          ...
          },
          {
            ...
            username: "utente4",
            userimage:
              "https://robohash.org/JamesWilson.png?size=50x50&set=set1",
            comment: "Sit amet",
            likes: [
              {
                userId: "userId00000001",
          ...
          [
            {
              ...
              username: "utente2",
              userimage:
                "https://robohash.org/JohnSmith.png?size=50x50&set=set1",
            ...
            },
            {
              ...
              username: "utente3",
              userimage:
                "https://robohash.org/EmmaDavis.png?size=50x50&set=set1",
      ...
      current: [
        {
          ...
          when: "2023-06-16 16:36:07",
          imageUrl: "https://picsum.photos/500/800?851",
          views: ["userId00000003", "userId00000001"],
          reply: ["userId00000003", "userId00000001"],
        },
      ],
      archive: [
        {
          ...
          when: "2022-06-16 16:36:07",
          imageUrl: "https://picsum.photos/500/800?851",
          views: ["userId00000004", "userId00000001"],
          reply: ["userId00000004", "userId00000001"],
        },
        {
          userId: "userId00000002",
          username: "utente2",
  ...
  },
  {
    userId: "userId00000003",
    username: "utente3",
    userimage: "https://robohash.org/JaneDoe.png?size=50x50&set=set1",
    verified: true,
    name: "Alice Johnson",
      ...
      current: [
        {
          ...
          when: "2023-06-16 16:36:07",
          imageUrl: "https://picsum.photos/500/800?851",
          views: ["userId00000002", "userId00000001"],
          reply: ["userId00000002", "userId00000001"],
        },
      ],
      archive: [
        {
